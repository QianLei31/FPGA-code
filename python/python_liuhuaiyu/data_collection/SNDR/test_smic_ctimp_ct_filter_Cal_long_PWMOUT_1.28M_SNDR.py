...
BYTES_DATA_POINTS=4
NUM_DATA_POINTS_READ=65536*16 #1.22Hz
#NUM_DATA_POINTS_READ=65536*4 #4.88Hz
#NUM_DATA_POINTS_READ=65536 #19.53Hz
#NUM_DATA_POINTS_READ=4096*1024 #0.3Hz
...
while (True):
    ...
    list_freq_plot,fft_recording,sndr_db,enob,K,IRN,snr_db,sfdr_db=fft_clean(array_adc_data_rec6,fs,1,200.516,8)
    ...
    sndr_result_text='SNDR = '+format(sndr_db,'0.2f')+'dB  ENOB = '+format(enob,'0.2f')+'b  IRN(300-10k)= '+format(IRN*10**6,'0.2f')+'uV'+' SNR = '+format(snr_db,'0.2f')+'dB'+' SFDR = '+format(sfdr_db,'0.2f')+'dB'
