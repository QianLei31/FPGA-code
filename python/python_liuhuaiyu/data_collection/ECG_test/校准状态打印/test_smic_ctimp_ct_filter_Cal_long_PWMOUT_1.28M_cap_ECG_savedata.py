...
while (True):
    ...
    sos = signal.butter(8,200,'lowpass',fs=50000000/39,output='sos') # 16k low pass   2-order
    adc_data_filtered = signal.sosfilt(sos, adc_data_to_filter)
    VPP_data=((max(adc_data_filtered[640000:-1])-min(adc_data_filtered[640000:-1]))/12)*1000
    ...
    if str_input[0] == 'y':
        dest_file_name=strPathSave+ "/" + "DATA_ECG_" + str(save_data_index)+".bin"
