...
NUM_DATA_POINTS_READ=4096*2048 #0.6Hz
...
while (True):
    ...
    list_freq_plot,fft_recording,sndr_db,enob,K,IRN=fft_clean(array_adc_data_rec6,fs,1,2890.62,8)
    ...
    if (IRN*10**6) <= (min_IRN-0.01):
        dest_file_name=strPathSave+ "/" + "ADC_DATA_SAVED_" + str(save_data_index)+ "_"+format(IRN*10**6,'0.2f')+ "uV_IRN_1kBW_20kCHOP" + ".bin"
