...
while (True):
    ...
    list_freq_plot,fft_recording,sndr_db,enob,K,VPP_CAL=fft_clean(array_adc_data_rec6,fs,1,200,2)
    ...
    axTime9.set_ylabel('CAP_SEL',fontsize=20)
