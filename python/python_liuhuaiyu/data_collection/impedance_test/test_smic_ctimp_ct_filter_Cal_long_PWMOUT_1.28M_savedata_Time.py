...
while (True):
    ...
    list_freq_plot,fft_recording,sndr_db,enob=fft_clean(array_adc_data_rec6,fs,1,300,8)
    ...
    if loop_index == 5:
            ...
            if str_input[0] == 'y':
                ...
                dest_file_name=strPathSave+ "/" + "ADC_DATA_SAVED_" + str(save_data_index)+ "_inputfreq="+str_input_freq+"Hz_"+"_inputamp="+str_input_amp+"mV_outputamp="+format(VPP_avg,'0.2f')+ "mV"+ ".bin"
