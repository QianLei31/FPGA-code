...
while (True):
    ...
    sos = signal.butter(8,400,'lowpass',fs=2560000,output='sos') # 16k low pass   2-order
    adc_data_filtered = signal.sosfilt(sos, adc_data_to_filter)
    VPP_data=((max(adc_data_filtered[256000:NUM_DATA_POINTS_READ-256000])-min(adc_data_filtered[256000:NUM_DATA_POINTS_READ-256000]))/12)*1000
    #average for 5 times
