...
while (True):
    ...
    axTime1 = plt.subplot(3, 2, 1)
    axTime2 = plt.subplot(3, 2, 3)
    axTime3 = plt.subplot(3, 2, 4)
    axTime4 = plt.subplot(3, 2, 2)
    axTime5 = plt.subplot(3, 2, 5)
    axFreq = plt.subplot(3, 2, 6)
    fs = 2560000
    ...
    list_freq_plot,fft_recording,sndr_db,enob=fft_clean(array_adc_data_rec6,fs,2,5937.5,8)
